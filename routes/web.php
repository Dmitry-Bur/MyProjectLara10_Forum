...
Route::middleware('auth')->group(function () {
    ...
    Route::patch('/notifications/update_collections', [\App\Http\Controllers\NotificationController::class, 'updateCollection']);
    ...
    Route::get('/test', function (){
        event(new \App\Events\StoreNotificationsEvent());
    });
